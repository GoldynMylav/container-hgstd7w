...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hgstd7w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hgstd7w.containers.anotherwebservice.com/
...
```
git clone git@github.com:GoldynMylav/container-hgstd7w.git
cd container-hgstd7w
```
...
```
docker attach container-hgstd7w
```
